...
- Integrated **Multi-Agent Swarm Support** (yapti_simulator/core/environment.py)
  - Configurable 
eceiver_count allowing synchronized multi-band scanning
  - MultiDiscrete action space for distributed array command
- Added **Hardware Imperfections / RF Dirt Layer** (yapti_simulator/rf/hardware.py)
  - Phase Noise (Oscillator Jitter)
  - ADC Clipping (Harmonic Saturation)
  - Configurable Thermal Noise (AWGN SNR)
  - I/Q Imbalance and IP3 Non-Linearity
- Added **Cognitive EW Engine** (yapti_simulator/ml/tactical_logger.py)
  - ExplainableAILogger for real-time translation of ML tensors into plain-English military tactical decisions
- Tensorized **RF Physics Engine** (yapti_simulator/rf/tensor_engine.py)
  - PyTorch-backed TorchRFSimulator for GPU-accelerated mass RF generation
