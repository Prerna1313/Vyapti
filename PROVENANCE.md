...
*   **Carrier Frequency:** Mapped to the complex exponent e^{j 2\pi f_c t}$.
...
2.  **Frequency Agile:** PRI remains stable, but $ hops pseudo-randomly across N discrete bands per pulse.
...
*   **The Firewall:** The VyaptiRFEnv implements a strict abstraction layer between the HiddenTruthGrid (which contains the exact coordinates of every pulse) and the AI's observation matrix.
...
Where \theta_{noise} is the Phase Noise oscillator jitter, and N(0, \sigma^2) represents the Thermal AWGN floor.
